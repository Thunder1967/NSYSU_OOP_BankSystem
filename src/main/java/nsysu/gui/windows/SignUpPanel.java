...
/**
 * This function is only for administrator for some reason
...
public class SignUpPanel extends JPanel {
    ...
    public SignUpPanel(JFrame parentFrame) {
        ...
        // Title
        JLabel titleLabel = new JLabel("Nice To Meet You", SwingConstants.CENTER); // Text
        ...
        // Subtitle
        JLabel subtitleLabel = new JLabel("Create an account", SwingConstants.CENTER); // Text
        ...
        GradientButton signUpButton = new GradientButton("SIGN UP", startColor, endColor, 16, ThemeColor.TEXT_WHITE);
        signUpButton.setPreferredSize(new Dimension(200, 45)); // Size
        gbc.gridy = 6;
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try{
                    ...
                    if (parentFrame instanceof MainGUI) {
                        // 假設妳之後會寫一個 DASHBOARD 頁面
                        ((MainGUI) parentFrame).switchToPage("DASHBOARD");
                    }
                }
        ...
        JLabel loginText = new JLabel("Have an account?");
        loginText.setForeground(new Color(148, 163, 184)); // Text color
        loginText.setFont(new Font("SansSerif", Font.PLAIN, 12));
        JLabel loginLink = createHyperlink("Login", SwingConstants.LEFT, () -> {
            parentFrame.getGlassPane().setVisible(false);
            ((MainGUI)parentFrame).applyCall(parentFrame, "LOGIN");
            System.out.println("Go to Login");
        });
        footerPanel.add(loginText);
